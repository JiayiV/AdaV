...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            ...
            """
            This line is to align the proposed method and the [CLS] attn. paper
            """
            index_masks = torch.ones_like(index_masks, device=index_masks.device).bool()
            ...
            #print("llava_arch.py, line 252, This route is called")
            ...
            for image_feature, index_mask in zip(image_features, index_masks):
                image_feature = image_feature[index_mask.to(image_feature.device)]
                new_image_features.append(image_feature)
